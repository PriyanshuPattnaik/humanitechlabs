...
import {
  ...
  set_class,
  set_style
} from "./chunk-IFELA3YV.js";
import "./chunk-U7P2NEEE.js";
import {
  append,
  from_html
} from "./chunk-GESDXHAS.js";
import {
  FILENAME,
  HMR,
  flushSync,
...
var Container = class {
  ...
  setNoise(noiseOrGenerator, init3, update) {
    if (!guardCheck(this)) {
      return;
    }
    this.setPath(noiseOrGenerator, init3, update);
  }
  setPath(pathOrGenerator, init3, update) {
...
var tsParticles = init2();
if (!isSsr()) {
  window.tsParticles = tsParticles;
}

// node_modules/svelte-particles/src/Particles.svelte
Particles2[FILENAME] = "node_modules/svelte-particles/src/Particles.svelte";
var root = add_locations(from_html(`<div></div>`), Particles2[FILENAME], [[75, 0]]);
function Particles2($$anchor, $$props) {
  check_target(new.target);
  push($$props, false, Particles2);
  let cssClass = prop($$props, "class", 12, "");
  let style = prop($$props, "style", 12, "");
  let options = prop($$props, "options", 28, () => ({}));
  let url = prop($$props, "url", 12, "");
  let id = prop($$props, "id", 12, "tsparticles");
  let particlesInit = prop($$props, "particlesInit", 12);
  const dispatch = createEventDispatcher();
  const particlesLoadedEvent = "particlesLoaded";
  let oldId = id();
  function destroyOldContainer() {
    if (oldId) {
      const oldContainer = tsParticles.dom().find((c) => strict_equals(c.id, oldId));
      if (oldContainer) {
...
if (import.meta.hot) {
  Particles2 = hmr(Particles2, () => Particles2[HMR].source);
  import.meta.hot.accept((module) => {
    module.default[HMR].source = Particles2[HMR].source;
    set(Particles2[HMR].source, module.default[HMR].original);
  });
}
